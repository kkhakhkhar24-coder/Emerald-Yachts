    ...
    return (
        <>
            ...
            <div className="fcel-page-wrapper">
                    ...
                    <div className="udrc-dest-container">
                        ...
                        <div className="udrc-dest-grid">
                            {danubeDestinations.map((dest, idx) => (
                                <div key={idx} className="udrc-dest-card">
                                    <div className="udrc-dest-icon-wrap">
                                        {dest.icon}
                                    </div>
                                    <h4 className="udrc-dest-name">{dest.name}</h4>
                    ...
                    <div className="urcr-review-container">
                        <div className="urcr-dining-container">
                            <div className="urcr-review-copy-col">
                                ...
                                <h3 className="urcr-review-title">Dining Onboard</h3>
                                <div className="fcel-heading-bar"></div>
                                <p className="fcel-lead-paragraph">
                    ...
                    <div className="urcr-review-container">
                        <div className="urcr-cabins-container">
                            <div className="urcr-review-copy-col">
                                ...
                                <h3 className="urcr-review-title">Luxury Accommodations</h3>
                                <div className="fcel-heading-bar"></div>
                                <p className="fcel-lead-paragraph">
                ...
                {/* PROS & CONS (MATCHED — urcr-pros-section & urcr-cons-section) */}
                <section className="urcr-pros-section urcr-bg-white">
                    <div className="urcr-pros-cons-container">
                        <div style={{ textAlign: 'center', marginBottom: '40px' }}>
                            <span className="fcel-eyebrow-label urcr-eyebrow-limitations">ADVANTAGES</span>
                            <h2 className="fcel-section-heading">Pros & Cons</h2>
                            <div className="fcel-heading-bar fcel-bar-center"></div>
                        </div>
                        <div className="urcr-pros-grid">
                            {danubePros.map((pro, idx) => (
                                <div key={idx} className={`urcr-pro-card ${idx === 3 ? 'urcr-pro-card-wide' : ''}`}>
                                    <div className="urcr-pro-icon-wrap">
                                        {pro.icon}
                                    </div>
                                    <h4 className="urcr-pro-title">{pro.title}</h4>
                                    <p className="urcr-pro-desc">{pro.desc}</p>
                                </div>
                            ))}
                        </div>
                    </div>
                ...
                <section className="urcr-cons-section urcr-bg-white">
                    <div className="urcr-pros-cons-container">
                        <div className="urcr-cons-heading-wrap" style={{ marginBottom: '40px' }}>
                            <span className="fcel-eyebrow-label urcr-eyebrow-limitations">LIMITATIONS</span>
                            <h3 className="fcel-section-heading">Cons</h3>
                            <div className="fcel-heading-bar fcel-bar-center"></div>
                        </div>
                        <div className="urcr-cons-grid">
                            {danubeCons.map((con, idx) => (
                                <div key={idx} className="urcr-con-card">
                                    <h4 className="urcr-con-title">
                                        <XCircle size={18} style={{ color: '#ef4444' }} />
                                        {con.title}
                                    </h4>
                                    <p className="urcr-con-desc">{con.desc}</p>
                                </div>
                            ))}
                        </div>
                    </div>
                ...
                <section className="fcel-faq-section">
                    <div className="fcel-faq-container">
                        <div style={{ textAlign: 'center' }}>
                            <span className="fcel-eyebrow-label">ANSWERS</span>
