...
const schema = {
    '@context': 'https://schema.org', '@graph': [
        { '@type': 'WebPage', '@id': 'https://www.tripsandships.com/best-luxury-expedition-cruises', 'name': 'Best Luxury Expedition Cruises', 'url': 'https://www.tripsandships.com/best-luxury-expedition-cruises', 'description': 'Expert guide to the best luxury expedition cruises, featuring top cruise lines, remote destinations, luxury ships, and unforgettable adventure experiences.', 'inLanguage': 'en-US', 'publisher': { '@id': 'https://www.tripsandships.com/#organization' }, 'mainEntity': { '@type': 'Article', '@id': 'https://www.tripsandships.com/best-luxury-expedition-cruises#article' } },
        { '@type': 'Organization', '@id': 'https://www.tripsandships.com/#organization', 'name': 'Trips & Ships Luxury Travel', 'url': 'https://www.tripsandships.com' },
        { '@type': 'TravelAgency', '@id': 'https://www.tripsandships.com/#travelagency', 'name': 'Trips & Ships Luxury Travel', 'url': 'https://www.tripsandships.com', 'description': 'Luxury travel agency specializing in luxury cruises, expedition cruises, yacht cruises, river cruises, and personalized travel planning.' },
        { '@type': 'Person', '@id': 'https://www.tripsandships.com/#angela-hughes', 'name': 'Angela Hughes', 'jobTitle': 'CEO', 'worksFor': { '@id': 'https://www.tripsandships.com/#travelagency' } },
        { '@type': 'Article', '@id': 'https://www.tripsandships.com/best-luxury-expedition-cruises#article', 'headline': 'Best Luxury Expedition Cruises', 'url': 'https://www.tripsandships.com/best-luxury-expedition-cruises', 'description': 'Expert guide to the world\'s best luxury expedition cruises, including top cruise lines, destinations, ships, wildlife encounters, and planning advice.', 'image': 'https://www.tripsandships.com/images/best-luxury-expedition-cruises.jpg', 'author': { '@id': 'https://www.tripsandships.com/#angela-hughes' }, 'publisher': { '@id': 'https://www.tripsandships.com/#organization' }, 'mainEntityOfPage': { '@id': 'https://www.tripsandships.com/best-luxury-expedition-cruises' } },
        { '@type': 'Service', 'name': 'Luxury Expedition Cruise Planning', 'provider': { '@id': 'https://www.tripsandships.com/#travelagency' }, 'serviceType': 'Luxury Expedition Cruise Consulting', 'description': 'Expert planning and personalized advice for luxury expedition cruises worldwide.' },
        { '@type': 'BreadcrumbList', 'itemListElement': [{ '@type': 'ListItem', 'position': 1, 'name': 'Home', 'item': 'https://www.tripsandships.com' }, { '@type': 'ListItem', 'position': 2, 'name': 'Expedition Cruises', 'item': 'https://www.tripsandships.com/expedition-cruises' }, { '@type': 'ListItem', 'position': 3, 'name': 'Best Luxury Expedition Cruises', 'item': 'https://www.tripsandships.com/best-luxury-expedition-cruises' }] },
