...
import AngelaImage from "../../assets/image.webp";
    ...
    <div className="wrapper">
      ...
      <section className="hero">
        <div className="hero-content">
          ...
          <p className="lead">
            Luxury Yacht Travel Has Changed. Most People Just Haven't Realized
            It Yet.
          </p>

          <p className="lead-sub">
            Private yacht-style journeys across the Mediterranean, Caribbean,
            and Northern Europe with Aman, Four Seasons, Ritz-Carlton, Orient
            Express, Scenic, and Emerald.
          </p>
      ...
      <section className="what-luxury">
        <div className="section-inner">
          ...
          <p>
            A luxury yacht cruise is a small-ship, ultra-luxury travel
            experience designed around privacy, space, and service. Unlike
            traditional cruises, these yachts carry fewer guests, offer
            suite-only accommodations, and focus on destination immersion rather
            than onboard scale.
          </p>
          <p className="emphasis">This is not cruising.</p>
          <p className="emphasis">
            This is the next category of luxury travel at sea.
          </p>
        </div>
      </section>
      ...
      <section className="editorial-block">
        <div className="section-inner">
          ...
          <p>
            Technically, it operates as a sailing yacht experience, but the
            better answer is that it is designed to feel far more like a private
            yacht than a traditional cruise.
          </p>
          <p className="emphasis">That distinction matters.</p>
          <p>
            For many travelers, the resistance to cruising has never been about
            the sea. It has been about scale, density, and the feeling that the
            experience was built for someone else. Orient Express Yachts
            addresses that gap with a lower-density concept, stronger design
            identity, and a more immersive sense of place. Its positioning,
            suite count, and Mediterranean launch all support that
            interpretation.
          </p>
        </div>
      </section>
      ...
      <section className="difference">
        <div
          ...
          style={{ backgroundImage: `url('${WhyThisIsDifferentBg}')` }}
        ></div>
        <div className="difference-content">
          <div className="difference-card">
            <h2>Why This Is Different</h2>
            <p>
              Most cruise products have historically been built around
              itinerary, volume, and logistics.
            </p>
            <p className="highlight-line">
              Orient Express Yachts is built around something else entirely.
            </p>
            <p>
              It is about space over density, environment over programming,
              design over sameness, and atmosphere over activity schedules. The
              brand is bringing the legacy of Orient Express into a floating,
              highly stylized setting that is meant to feel curated rather than
              crowded.
            </p>
            <p>
              This is why it matters so much for travelers who have never really
              seen themselves on a cruise.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="experience">
        <div className="section-inner wide">
          ...
          <p>
            The onboard experience is where this product begins to separate
            itself.
          </p>
          <p>
            Official Orient Express materials describe a layered experience that
            includes restaurants and bars, a marina, wellness spaces, a cabaret,
            a cinema, a game room, a music salon, and a library. Accor's press
            materials also confirm five restaurants and private dining spaces, a
            115-seat cabaret, a state-of-the-art recording studio, two pools,
            and a marina. Culinary direction for Orient Express Corinthian is
            led by Yannick Alléno.
          </p>
          <p>
      ...
      <section className="suites">
        <div className="suites-inner">
          <div
            className="suites-image"
            style={{ backgroundImage: `url('${SuitesSpaceImage}')` }}
          ></div>
          <div className="suites-text">
            <h2>Suites and Space</h2>
            <p>One of the strongest selling points is the sense of space.</p>
            <p>
              Accor states that the yacht's 54 suites range from 485 square feet
              to 2,476 square feet, with expansive picture windows or terraces
              and elevated ceilings. That is materially different from how most
              travelers think about accommodation at sea.
            </p>
            <p className="emphasis">
              For the right traveler, that changes the entire conversation.
            </p>
            <p>
              This is not about fitting into a cabin. It is about inhabiting a
              beautifully designed environment that happens to move through the
              Mediterranean.
            </p>
          </div>
        </div>
      ...
      <section className="pricing">
        <div className="section-inner">
          ...
          <p>
            Pricing is expected to place Orient Express Yachts at the very top
            of the ultra-luxury market.
          </p>
          <p>
            While the brand's public materials emphasize itinerary availability
            and booking status rather than a simple universal rate card, the
            overall product positioning, suite scale, culinary leadership, and
            density strongly suggest a mid five-figure starting point per person
            and upward, depending on suite category, season, and itinerary. That
            pricing expectation is an inference based on the official product
            profile and positioning rather than a single published flat rate.
          </p>
          <p className="emphasis">This is not a price-first product.</p>
          <p>
            It is a product for travelers choosing for rarity, design, access,
            and experience.
          </p>
        </div>
      </section>
        ...
        <div className="section-inner wide">
          <div className="video-header">
            ...
            <p className="video-subtitle">
              Step into a new era of ultra-luxury travel. The Orient Express
              Corinthian reimagines the legendary heritage of the world's most
              iconic train as a futuristic sailing yacht, blending timeless
              elegance with state-of-the-art maritime innovation.
            </p>
          </div>
          ...
          <div className="video-caption">
            ...
            <p>
              A legendary heritage reborn as the world's largest sailing yacht,
              offering 54 ultra-luxury suites and a revolutionary design that
              pushes the boundaries of private yacht travel.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="sustainability">
        <div className="section-inner">
          ...
          <p>
            Sustainability is part of the product story, but in this case it is
            also part of the appeal.
          </p>
          <p>
            Orient Express has positioned this as a sailing yacht experience,
            and the brand's official messaging centers the vessel's identity as
            a large-scale sailing concept rather than a conventional cruise
            ship. What matters for the consumer page is that this is being
            framed as a more future-facing, design-led approach to ultra-luxury
            travel at sea.
          </p>
          <p className="emphasis">
            For many luxury travelers, that combination of innovation and
            elegance is part of the draw.
          </p>
        </div>
      </section>
      ...
      <section className="audience">
        <div className="section-inner">
          ...
          <div className="audience-list">
            ...
            <p>
              Prefer private villas, yachts, and more design-driven environments
            </p>
            <p>Value privacy, atmosphere, and a quieter pace</p>
            <p>
              Want something newer and more distinctive than a standard luxury
              cruise
            </p>
            <p>Want to integrate a sailing into a broader Europe itinerary</p>
          </div>
          <p className="emphasis">
            If you have ever said, "I do not think cruising is for me," this may
            be the first product that genuinely challenges that assumption.
          </p>
        </div>
      </section>
      ...
      <section className="compare">
        <div className="compare-inner">
          <div className="compare-text">
            ...
            <p>
              Orient Express Yachts enters a space that already includes
              products that blend hospitality and small-ship luxury.
            </p>
            <p>
              What makes this stand apart is the strength of the Orient Express
              brand identity, the emphasis on sailing, the highly stylized
              design point of view, the intimate suite count, and the framing of
              the journey itself as part of the allure. The official brand
              language leans much more heavily into heritage, craftsmanship, and
              the Mediterranean experience than into conventional cruise
              messaging.
            </p>
      ...
      <section className="angela">
        <div className="angela-inner">
          <div className="angela-text-side">
            <h2>Why Work with Angela Hughes and Trips & Ships Luxury Travel</h2>
            <p className="angela-lead">
              Angela Hughes leads this work personally.
            </p>
            <p>
              She is the CEO and Founder of Trips & Ships Luxury Travel and one
              of the most recognized voices in luxury travel today.
            </p>
            <div className="angela-points">
              ...
              <p>
                Named one of the Most Influential Women in Travel 2026 by
                TravelPulse
              </p>
              <p>
                Named Luxury Travel Influencer of the Year 2024 by Travel
                Leaders Network
              </p>
            ...
            <p className="emphasis">
              It is to interpret where the market is going and help clients
              decide whether something is truly right for them.
            </p>
            ...
            <p>
              While Angela leads the strategy and client experience, she is
              supported by a team of more than 140 luxury travel advisors and
              operational specialists within Trips & Ships Luxury Travel.
            </p>
            ...
            <p>
              It is a high-touch experience supported by both leadership and
              infrastructure.
            </p>
          </div>
          <div className="angela-image-side">
            <div className="angela-photo-container">
              <img
                src={AngelaImage}
                alt="Angela Hughes"
                className="angela-photo"
              />
            </div>
          </div>
        </div>
      ...
      <section className="availability">
        <div className="section-inner">
          ...
          <p>
            With only 54 suites, this is a limited-inventory product from the
            start. Official Orient Express itinerary pages already show
            booking-driven sailings, call-for-availability language on some
            departures, and a clear emphasis on early planning.
          </p>
      ...
      <section
        className="final-cta"
        style={{ backgroundImage: `url('${PrivateConsultationBg}')` }}
      >
        <div className="final-cta-inner">
          ...
          <p className="cta-emphasis">
            If this aligns with how you want to travel, the next step is a
            conversation.
          </p>
