...
"
                ...
                <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
                    ...
                    <div style={{
                        ...
                        <iframe
                            width="100%"
                            height="100%"
                            src="https://www.youtube.com/embed/qPDf_QdCg8E"
            ...
            <section className="medi-video-section" style={{ background: '#f8fafc', padding: '80px 20px', textAlign: 'center', position: 'relative' }}>
                <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
                    <h2 className="medi-section-heading">Experience the Greece with Azamara</h2>
                    <div className="medi-heading-separator-bar medi-bar-centered"></div>
                    ...
                    <div style={{
                        ...
                        <iframe
                            width="100%"
                            height="100%"
                            src="https://www.youtube.com/embed/RqBbg5sOIug"
