...
// import hero2 from '../../assets/ExploraVsCrystal/hero2.jpg'
// import hero3 from '../../assets/ExploraVsCrystal/hero3.jpg'

// import exploraShipImg    from '../../assets/ExploraVsCrystal/explora-ship.webp'
// import crystalShipImg    from '../../assets/ExploraVsCrystal/crystal-ship.webp'
// import exploraDiningImg  from '../../assets/ExploraVsCrystal/explora-dining.webp'
// import crystalDiningImg  from '../../assets/ExploraVsCrystal/crystal-dining.webp'
// import exploraSuiteImg   from '../../assets/ExploraVsCrystal/explora-suite.webp'
// import crystalSuiteImg   from '../../assets/ExploraVsCrystal/crystal-suite.webp'
// import exploraWellnessImg from '../../assets/ExploraVsCrystal/explora-wellness.webp'
// import crystalEntImg     from '../../assets/ExploraVsCrystal/crystal-entertainment.webp'
                ...
                <div className="evc-service-container">
                    ...
                    <div className="evc-bento-grid">
                        ...
                        <div className="evc-bento-card evc-bento-img-card evc-bento-span2">
                            {/* <img src={exploraShipImg} alt="Explora Service" className="evc-bento-bg-img" /> */}
                        ...
                        {/* text card — Crystal service */}
                        <div className="evc-bento-card evc-bento-text-card">
                            <div className="evc-bento-icon-box"><Award size={24} /></div>
                            <span className="evc-bento-label evc-label-dark">CRYSTAL SERVICE</span>
                            <h3 className="evc-bento-card-title evc-title-dark">World-Class Personalized Service</h3>
                            <p className="evc-bento-card-text evc-text-dark">Crystal is consistently recognized for delivering some of the finest service at sea. Its experienced crew, high staff-to-guest ratio, and personalized attention create a truly luxurious experience.</p>
                        </div>

                        {/* text card — Explora entertainment */}
                        <div className="evc-bento-card evc-bento-text-card evc-bento-soft">
                            <div className="evc-bento-icon-box evc-icon-navy"><Music size={24} /></div>
                            <span className="evc-bento-label evc-label-dark">EXPLORA ENTERTAINMENT</span>
                            <h3 className="evc-bento-card-title evc-title-dark">Elegant &amp; Understated</h3>
                            <p className="evc-bento-card-text evc-text-dark">Live music, cocktail lounges, cultural performances, piano entertainment, and elegant evening ambiance — sophisticated over spectacle.</p>
                        </div>
                    ...
                    <div className="evc-verdict-grid">
                        <div className="evc-verdict-card">
                            <div className="evc-verdict-img-wrap">
                                {/* <img src={exploraShipImg} alt="Explora Journeys" className="evc-verdict-img" /> */}
