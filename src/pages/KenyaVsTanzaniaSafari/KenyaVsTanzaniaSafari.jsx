...
export default function KenyaVsTanzaniaSafari() {
    ...
    const faqs = [
        {
            ...
            answer: "Both are exceptional, but Kenya is often better for shorter, high-impact trips while Tanzania is better for longer, immersive journeys."
        },
        {
            question: "What is the difference between the Maasai Mara and the Serengeti?",
            answer: "The Maasai Mara is compact with dense wildlife, while the Serengeti is vast and offers more varied landscapes and movement."
        },
        {
            question: "When is the best time to see the Great Migration in Kenya vs Tanzania?",
            answer: "Kenya is best for river crossings from July through October. Tanzania offers migration viewing year-round depending on herd location."
        },
        {
            question: "Is Kenya better for first-time safari travelers?",
            answer: "Often yes, due to easier logistics, shorter travel distances, and strong wildlife sightings."
        },
        {
            question: "Is Tanzania better for experienced safari travelers?",
            answer: "Often yes, because it allows for deeper exploration across multiple regions."
        },
        {
            question: "How much does a Kenya vs Tanzania luxury safari cost?",
            answer: "Typically between $25,000 and $45,000+ per person depending on design and season."
        },
        {
            question: "Can I combine Kenya and Tanzania in one trip?",
            answer: "Yes, and for many travelers this creates the most complete East Africa safari experience."
        },
        {
            question: "Which destination has better wildlife sightings?",
            answer: "Both offer exceptional wildlife, but Kenya tends to provide more concentrated sightings while Tanzania offers more diversity."
        },
        {
            question: "Is Tanzania more remote than Kenya?",
            answer: "Yes, Tanzania generally feels more remote due to its scale and longer travel distances."
        },
        {
        ...
        },
        {
            ...
            answer: "Yes, this is one of the most popular safari and beach combinations."
        },
        {
            question: "What is the biggest mistake travelers make?",
            answer: "Choosing based on price instead of experience and itinerary design."
        },
        {
            question: "How long should a safari be in Kenya vs Tanzania?",
            answer: "Kenya works well in 7 to 10 days, while Tanzania typically requires 10 to 14 days or more."
        },
        {
            question: "Are safaris in Kenya and Tanzania similar?",
            answer: "They share ecosystems but feel very different in pacing, structure, and scale."
        },
        {
            question: "Do I need a travel advisor for a safari?",
            answer: "For luxury safaris, expert planning is critical and directly impacts the outcome of the trip."
        }
    ];
    ...
    return (
        <div className="kvts-root">
                    ...
                    <div className={`kvts-hero-details ${showContent ? "expanded" : ""}`}>
                        <div className="kvts-snippet-card">
                            ...
                            <p className="kvts-hero-p">
                                Not all safaris are created equal, and Kenya and Tanzania are not interchangeable.
                            </p>
                            <p className="kvts-hero-p kvts-mt-sm">
                                Both destinations sit within the same ecosystem and both can deliver extraordinary wildlife experiences. But how they feel, how they are structured, and how they are experienced on the ground are very different.
                            </p>
                            <p className="kvts-hero-p kvts-mt-sm">
                                With over four decades in the travel industry, travel to 121+ countries, and more than 10 safaris across Africa in recent years, Angela Hughes works with clients to determine which destination or combination will actually deliver the experience they are expecting.
                            </p>
                            <p className="kvts-hero-p kvts-mt-sm">
                                This is not about picking the more famous destination. It is about getting the safari right.
                            </p>
                        </div>
                    </div>

                    <button className="kvts-hero-toggle" onClick={() => setShowContent(!showContent)}>
                        <span className="kvts-flex-center">
                            {showContent
                                ? <Minus size={14} style={{ marginRight: "6px" }} />
                                : <Plus size={14} style={{ marginRight: "6px" }} />
                            }
                            {showContent ? "Hide Expert Overview" : "View Expert Overview"}
                        </span>
                    </button>

                    <div className="kvts-hero-btns">
                        <button className="kvts-btn-primary">
            ...
            {/* ── 3. TRUST SECTION (V6 AIRY) ── */}
            <section className="kvts-section kvts-trust-v6">
                <div className="kvts-container">
                    <div className="kvts-trust-v6-split">

                        <div className="kvts-v6-left">
                            <h2 className="kvts-h2">Why Trust This Guide</h2>
                            <div className="kvts-v6-accent"></div>

                            <p className="kvts-p-display kvts-v6-lead">
                                Angela Hughes brings real, on-the-ground experience to safari planning.
                            </p>

                            <div className="kvts-v6-profile">
                                <img src={profileImg} alt="Angela Hughes" className="kvts-v6-avatar" />
                                <div className="kvts-v6-profile-info">
                                    <span className="kvts-v6-name">Angela Hughes</span>
                                    <span className="kvts-v6-title">CEO, Trips & Ships Luxury Travel</span>
                                </div>
                            </div>

                            <p className="kvts-p-display kvts-v6-quote">
                                "This is not theory. This is experience built over decades."
                            </p>
                        </div>

                        <div className="kvts-v6-right">
                            <div className="kvts-v6-list">
                                {[
                                    { icon: Compass, text: "40+ years in the travel industry" },
                                    { icon: Globe, text: "Travel to 121+ countries worldwide" },
                                    { icon: Map, text: "10+ safaris across Africa in recent years" },
                                    { icon: Briefcase, text: "CEO of Trips & Ships Luxury Travel" },
                                    { icon: Award, text: "Travel Leaders Network Advisory Board Member" },
                                    { icon: Star, text: "Featured in Travel Weekly, TravelPulse, Insider Travel Report and more" }
                                ].map((item, index) => (
                                    <div className="kvts-v6-item" key={index}>
                                        <div className="kvts-v6-icon-wrap">
                                            <item.icon size={24} />
                                        </div>
                                        <p className="kvts-p kvts-v6-text">{item.text}</p>
                                    </div>
                                ))}
                            </div>
                        </div>
            ...
            {/* ── 3. PRIMARY CTA ── */}
            <section className="kvts-section kvts-cta">
                <div className="kvts-container">
                    <div className="kvts-cta-inner">
                        <div className="kvts-cta-left">
                            <h2 className="kvts-h2 kvts-cta-h2">
                                Schedule a 15-Minute Luxury Safari Consultation with Angela Hughes
                            </h2>
                            <p className="kvts-p kvts-cta-p">
                                Designed for travelers deciding between Kenya and Tanzania who want to get it right the first time.
                            </p>
                        </div>
                        <div className="kvts-cta-right">
                            <button className="kvts-cta-btn">
            ...
            <section className="kvts-section kvts-comparison-v2">
                <div className="kvts-container">
                    ...
                    <div className="kvts-comp-v2-header">
                        <h2 className="kvts-h2">Kenya vs Tanzania Safari: Quick Comparison</h2>
                        ...
                        <div className="kvts-comp-v2-card">
                            ...
                            <div className="kvts-comp-v2-card-body">
                                {[
                                    ...
                                    { label: "Safari style", val: "High-impact, shorter itineraries" },
                        ...
                        <div className="kvts-comp-v2-card kvts-comp-v2-tanzania">
                            ...
                            <div className="kvts-comp-v2-card-body">
                                {[
                                    ...
                                    { label: "Wildlife density", val: "Spread across vast regions" },
                ...
                <div className="kvts-container">
                    ...
                    <div className="kvts-best-for-grid">
                        ...
                        <div className="kvts-best-card">
                            <div className="kvts-best-card-icon"><Map size={28} /></div>
                            <h3 className="kvts-best-card-title">Choose Kenya if you want</h3>
                            <ul className="kvts-best-list">
                                <li><CheckCircle2 size={18} /> <span>A powerful first safari experience that delivers quickly</span></li>
                                <li><CheckCircle2 size={18} /> <span>The Maasai Mara, one of the most wildlife-dense regions in Africa</span></li>
                                <li><CheckCircle2 size={18} /> <span>Strong predator sightings and consistent game viewing</span></li>
                                <li><CheckCircle2 size={18} /> <span>Easier logistics with less time in transit</span></li>
                                <li><CheckCircle2 size={18} /> <span>A shorter trip that still feels complete</span></li>
                            </ul>
                        </div>

                        {/* Tanzania */}
                        <div className="kvts-best-card kvts-best-card-tanzania">
                            <div className="kvts-best-card-icon"><Compass size={28} /></div>
                            <h3 className="kvts-best-card-title">Choose Tanzania if you want</h3>
                            <ul className="kvts-best-list">
                                <li><CheckCircle2 size={18} /> <span>The Serengeti and Ngorongoro Crater</span></li>
                                <li><CheckCircle2 size={18} /> <span>A longer safari with more geographic variation</span></li>
                                <li><CheckCircle2 size={18} /> <span>Expansive landscapes and a sense of scale</span></li>
                                <li><CheckCircle2 size={18} /> <span>A safari combined with Zanzibar for a beach finish</span></li>
                                <li><CheckCircle2 size={18} /> <span>A deeper, more immersive East Africa experience</span></li>
                            </ul>
                        </div>

                        {/* Both */}
                        <div className="kvts-best-card kvts-best-card-both">
                            <div className="kvts-best-card-icon"><Globe size={28} /></div>
                            <h3 className="kvts-best-card-title">Choose Both Kenya and Tanzania if you want</h3>
                            <ul className="kvts-best-list">
                                <li><CheckCircle2 size={18} /> <span>The full East Africa safari experience</span></li>
                                <li><CheckCircle2 size={18} /> <span>Maasai Mara and Serengeti in one itinerary</span></li>
                                <li><CheckCircle2 size={18} /> <span>A longer, high-budget trip with maximum diversity</span></li>
            ...
            <section className="kvts-section kvts-cta-mid">
                <div className="kvts-container kvts-cta-mid-container">
                    <div className="kvts-cta-mid-text">
                        <h2 className="kvts-h2">Schedule a 15-Minute <br /> Safari Strategy Call</h2>
                        <p>Because the difference between a good safari and an exceptional one is how it is designed.</p>
                    </div>
                        ...
                        <div className="kvts-why-kenya-right">
                            <div className="kvts-why-kenya-stack">
                                <div className="kvts-why-kenya-item">
                                    <div className="kvts-why-kenya-icon"><Sparkles size={28} /></div>
                                    <p>Kenya is often the strongest entry point into safari for one simple reason. It delivers.</p>
                                </div>
                                <div className="kvts-why-kenya-item">
                                    <div className="kvts-why-kenya-icon"><Map size={28} /></div>
                                    <p>The Maasai Mara is known for consistent wildlife density, high predator activity, and relatively compact geography. That means less time driving between regions and more time actually experiencing wildlife.</p>
                                </div>
                                <div className="kvts-why-kenya-item">
                                    <div className="kvts-why-kenya-icon"><Award size={28} /></div>
                                    <p>Kenya also benefits from strong infrastructure, well-established safari routes, highly trained guides, and efficient internal flights.</p>
                                </div>
                                <div className="kvts-why-kenya-item">
                                    <div className="kvts-why-kenya-icon"><Star size={28} /></div>
                                    <p>For many travelers, especially those new to Africa, Kenya creates a sense of ease without sacrificing quality.</p>
                                </div>
                            </div>
                        </div>
            ...
            <section className="kvts-section kvts-why-tanzania">
                <div className="kvts-container">
                    ...
                    <div className="kvts-why-tanzania-grid">
                        ...
                        <div className="kvts-why-tanzania-card">
                            <div className="kvts-why-tanzania-icon"><Map size={28} /></div>
                            <p>The Serengeti is vast. Ngorongoro Crater is dramatic. Tarangire has a completely different feel.</p>
                        </div>
                        <div className="kvts-why-tanzania-card">
                            <div className="kvts-why-tanzania-icon"><Compass size={28} /></div>
                            <p>This creates more varied landscapes, a slower pace, and longer time in the bush.</p>
                        </div>
                        <div className="kvts-why-tanzania-card">
                            <div className="kvts-why-tanzania-icon"><Award size={28} /></div>
                            <p>Tanzania can feel less structured and more expansive, which is exactly what some travelers are looking for. But it also requires more time, more strategic routing, and stronger logistical planning.</p>
                        </div>
                        <div className="kvts-why-tanzania-card">
                            <div className="kvts-why-tanzania-icon"><Star size={28} /></div>
                            <p>Without that, it can feel long and disconnected. When done right, it is extraordinary.</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="kvts-section kvts-mistakes">
                <div className="kvts-container">
                    <div className="kvts-mistakes-header">
                        <h2 className="kvts-h2">KENYA VS TANZANIA: WHAT LUXURY TRAVELERS OFTEN GET WRONG</h2>
                        <p className="kvts-mistakes-subtitle">This is where most safaris succeed or fail.</p>
                        <div className="kvts-mistakes-accent"></div>
                    </div>
                    <div className="kvts-mistakes-grid">
                        <div className="kvts-mistakes-item">
                            <div className="kvts-mistakes-icon"><AlertTriangle size={22} /></div>
            ...
            <section className="kvts-section kvts-migration-clean">
                <div className="kvts-container">
                    ...
                    <div className="kvts-migration-clean-header">
                        <h2 className="kvts-h2">KENYA VS TANZANIA FOR <br /> THE GREAT MIGRATION</h2>
                        <div className="kvts-migration-clean-accent"></div>
                        <p className="kvts-migration-clean-intro">
                            The Great Migration is not one event. It is a year-round movement across the Serengeti–Maasai Mara ecosystem.
                        </p>
                    </div>
                    ...
                    <div className="kvts-migration-clean-grid">
                        ...
                        <div className="kvts-migration-clean-card">
                            <div className="kvts-migration-clean-card-head">
                                ...
                                <span className="kvts-migration-clean-label">Kenya Focus</span>
                            </div>
                            <p>Kenya is known for dramatic river crossings in the Maasai Mara, typically July through October.</p>
                        </div>
                        ...
                        <div className="kvts-migration-clean-card">
                            <div className="kvts-migration-clean-card-head">
                                ...
                                <span className="kvts-migration-clean-label">Tanzania Focus</span>
                            </div>
                    ...
                    <div className="kvt-lux-sticky-wrapper">
                        ...
                        <div className="kvt-lux-sticky-left">
                            <div className="kvt-lux-sticky-header">
                                <h2 className="kvt-lux-sticky-h2">KENYA VS TANZANIA FOR LUXURY TRAVELERS</h2>
                            ...
                            <div className="kvt-lux-clean-wrap">
                                ...
                                <div className="kvt-lux-clean-intro">
                                    ...
                                    <div className="kvt-lux-clean-list">
                                        {[
                                            { title: "The Guide", desc: "The expert who interprets the bush and makes every moment count." },
                                            { title: "The Timing", desc: "Being in the right place at the exact right moment of the season." },
                                            { title: "The Routing", desc: "A logical, efficient path that maximizes wildlife viewing time." },
                                            { title: "Camp Location", desc: "Private concessions and exclusive access points away from the crowds." },
                                            { title: "The Operator", desc: "The invisible hand that ensures safety, logistics, and total luxury." }
                                        ].map((item, idx) => (
                                ...
                                <div className="kvt-lux-clean-footer">
                                    <div className="kvt-lux-clean-verdict">
                                        <p className="kvt-lux-clean-p">
                                            Both Kenya and Tanzania can deliver exceptional luxury experiences, but <span className="kvt-lux-clean-high">only when they are designed correctly.</span>
                                        </p>
                                        <div className="kvt-lux-clean-alert">
                                            <AlertCircle size={18} className="kvt-lux-clean-icon" />
                                            <span className="kvt-lux-clean-status">This is where most trips succeed or fail.</span>
                                        </div>
                                    </div>
                                </div>
                ...
                <div className="kvts-container">
                    <div className="kvt-video-split">
                        <div className="kvt-video-copy">
                            ...
                            <h2 className="kvts-h2">Experience the <br /> Great Migration</h2>
                            <div className="kvt-video-accent"></div>
                            <p className="kvts-p">
                                Witness the dramatic river crossings and vast landscapes that define the East African safari.
                                Understanding the movement of the herds is key to designing a successful luxury itinerary.
                            </p>
                        </div>
                    ...
                    <div className="kvt-cost-v7-split">
                        ...
                        <div className="kvt-cost-v7-value">
                            <div className="kvt-cost-v7-price-card">
                                <span className="kvt-cost-v7-label">Expert Pricing Estimate</span>
                                ...
                                <p className="kvt-cost-v7-per">Per person for high-end experiences</p>
                            </div>
                        ...
                        <div className="kvt-cost-v7-logic">
                            <h2 className="kvt-cost-v7-h2">KENYA VS TANZANIA <br /> SAFARI COST</h2>
                            <div className="kvt-cost-v7-accent"></div>

                            <p className="kvt-cost-v7-p kvts-mt-md">
                                Luxury safaris in Kenya and Tanzania sit in the same general pricing tier.
                            </p>

                            <div className="kvt-cost-v7-factors">
                                <h3 className="kvt-cost-v7-factors-h3">Primary Cost Pillars:</h3>
            ...
            <section className="kvt-wrong-v3-section">
                <div className="kvt-wrong-v3-container">
                    ...
                    <div className="kvt-wrong-v3-header">
                        <h2 className="kvt-wrong-v3-h2">WHAT CAN GO WRONG WHEN <br /> CHOOSING THE WRONG DESTINATION</h2>
                    ...
                    <div className="kvt-wrong-v3-footer">
                        <p className="kvt-wrong-v3-conclusion">
                            These are the differences between a good trip and an exceptional one.
                        </p>
                    </div>
                </div>
            </section>
            ...
            {/* ── 15. FINAL CTA ── */}
            <section className="kvt-final-cta-section">
                <div className="kvt-final-cta-container">

                    <div className="kvt-final-cta-spread">

                        <div className="kvt-final-cta-content">
                            <span className="kvt-final-cta-eyebrow">FINAL CALL TO ACTION</span>
                            <h2 className="kvt-final-cta-h2">Schedule a 15-Minute <br /> Luxury Safari Consultation</h2>
                            <p className="kvt-final-cta-lead">
                                Choosing between Kenya and Tanzania is not about picking a destination. <br /> It is about designing the right experience.
                            </p>
                            <p className="kvt-final-cta-support">
                                Angela Hughes and Trips & Ships Luxury Travel create safari itineraries that are built to deliver.
                            </p>
                        </div>

                        <div className="kvt-final-cta-action">
                            <div className="kvt-final-cta-button-wrap">
                                <button className="kvt-final-cta-btn">
                                    Book Your Consultation
                                    <ChevronRight size={20} className="kvt-final-cta-arrow" />
                                </button>
                                <div className="kvt-final-cta-badge">
                                    <Award size={16} />
