...
const Japanlandvscruise = () => {
  ...
  const heroImages = [Herobg1, Herobg4, Herobg3];
    ...
    <>
      ...
      <section className="japan-hero">
        ...
        <div className="japan-hero-content">
          <span className="japan-hero-eyebrow">
          ...
          <p className="japan-hero-lead">
            Japan is not a cruise-first destination. It is a land-first
            destination that can include cruising. Most travelers think they
            want to see Japan. What they actually want is to feel it.
          </p>

          <div className={`japan-hero-details ${readMore ? "expanded" : ""}`}>
            <p className="japan-hero-lead">
              If you are deciding between a land itinerary and a cruise in
              Japan, the real question is not which one is better. It is which
              one is better for how you want to experience the country.
            </p>
            <p className="japan-hero-lead">
              After living in Japan and designing custom trips there for years,
              I can tell you this: one gives you depth, the other gives you
              ease. The right choice depends on your priorities.
            </p>
          </div>
          ...
          <div className="japan-hero-btns">
            <a href="#planning" className="japan-btn-primary">
              Plan My Japan Trip
            </a>
          </div>
        </div>
          ...
          <div className="japan-expert-grid">
              ...
              <div className="japan-expert-card">
                <div className="japan-expert-image-wrap">
                  <img
                    src={AngelaImg}
                    alt="Angela Hughes"
                    className="japan-expert-image"
                  />
                </div>
                <h2 className="japan-expert-name">Angela Hughes</h2>
                <span className="japan-expert-title">
                  CEO, Trips & Ships Luxury Travel
                </span>
                <ul className="japan-expert-stats">
                  <li>
                    <Award size={18} className="japan-expert-icon" /> 40+ years
                    in the travel industry
                  </li>
                  <li>
                    <MapPin size={18} className="japan-expert-icon" /> Lived in
                    Japan and returns regularly
                  </li>
                  <li>
                    <Compass size={18} className="japan-expert-icon" /> Designs
                    custom itineraries across Tokyo, Kyoto, Osaka
                  </li>
                  <li>
                    <Users size={18} className="japan-expert-icon" /> Leads a
                    team of 140+ luxury travel advisors
                  </li>
                </ul>
              </div>
            </aside>
            ...
            <div className="japan-expert-content">
              ...
              <p className="japan-section-p">
                ...
                one comes down to structure, timing, and access.
              </p>
              <div className="japan-highlight-box">
                <p className="japan-section-p">
                  "Working directly with hotels and on-the-ground partners, I
                  ensure every detail of your Japanese journey is curated for
                  maximum cultural immersion and luxury."
                </p>
              </div>
            ...
            <div className="japan-gallery-images">
              <div className="japan-main-frame">
                <img
                  src={Herobg2}
                  alt="Japan Scene"
                  className="japan-gallery-img-main"
                />
                <div className="japan-vertical-label">Editorial Insight</div>
              </div>
              <div className="japan-sub-frame">
                <img
                  src={Japanlandvscruise3}
                  alt="Arashiyama bamboo forest pathway in Kyoto Japan immersive experience curated by Angela Hughes
"
                  className="japan-gallery-img-sub"
                />
              </div>
            </div>
            ...
            <div className="japan-floating-insight">
              ...
              <h2 className="japan-h2 jlc-insight-title">
                Is It Better to Travel Japan by Land or Cruise?
              </h2>

              <div className="japan-editorial-p jlc-insight-p-wrap">
                <p className="japan-section-p jlc-text-white">
                  For most travelers,{" "}
                  <strong>Japan is better experienced by land</strong> because
                  it allows deeper cultural immersion, better food access, and
                  more time in key cities like Tokyo and Kyoto.
                </p>
                <p className="japan-section-p jlc-text-white-muted">
                  A cruise is a good option for travelers who prioritize
                  convenience, prefer a slower pace, or want to combine Japan
              ...
              <div className="japan-asymmetric-quote">
                <p>
                  "The choice isn't about which is better—it's about which layer
                  of Japan you want to peel back."
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="japan-section japan-bg-navy">
        <div className="japan-inner">
          <h2 className="japan-h2 japan-h2-centered jlc-text-white">
            Japan Land vs Cruise{" "}
          </h2>
          <div className="japan-choice-grid jlc-mt-60">
            <div className="japan-choice-card land">
              <h3 className="jlc-text-navy-dark">
                Choose Land Travel if you want:
              </h3>
              <ul className="japan-choice-list">
                <li>
                  <BookOpen size={22} className="japan-expert-icon" /> Cultural
                  depth
                </li>
                <li>
                  <MapPin size={22} className="japan-expert-icon" /> Time in
                  Tokyo, Kyoto, and Osaka
                </li>
                <li>
                  <Utensils size={22} className="japan-expert-icon" /> Better
                  food experiences
                </li>
                <li>
                  <Compass size={22} className="japan-expert-icon" />{" "}
                  Flexibility and customization
                </li>
                <li>
                  <Star size={22} className="japan-expert-icon" /> A stronger
                  first trip
                </li>
              </ul>
            </div>
            <div className="japan-choice-card cruise">
              ...
              <ul className="japan-choice-list">
                <li>
                  <Zap size={22} className="jlc-text-white" /> Simplicity
                </li>
                <li>
                  <Clock size={22} className="jlc-text-white" /> A relaxed pace
                </li>
                <li>
                  <Layers size={22} className="jlc-text-white" /> To unpack once
                </li>
                <li>
                  <Globe size={22} className="jlc-text-white" /> A multi-country
                  itinerary
                </li>
                <li>
                  <Ship size={22} className="jlc-text-white" /> A familiar
                  travel format
                </li>
              </ul>
            </div>
      ...
      <section className="japan-section japan-bg-soft">
        <div className="japan-inner">
          <h2 className="japan-h2 japan-h2-centered">
            If You Only Have 10 Seconds
          </h2>
          <div className="jlc-summary-grid">
            <div className="jlc-summary-list-content">
              <div className="jlc-summary-list">
                <div className="japan-expert-card jlc-summary-item">
                  ...
                  <p className="japan-section-p jlc-m-0">
                    <strong>Choose land travel</strong> if Japan is your main focus.
                  </p>
                </div>
                <div className="japan-expert-card jlc-summary-item">
                  <Clock size={24} className="japan-expert-icon" />
                  <p className="japan-section-p jlc-m-0">
                    <strong>Choose a cruise</strong> if you want ease and a broader
                    Asia experience.
                  </p>
                </div>
                <div className="japan-expert-card jlc-summary-item">
                  ...
                  <p className="japan-section-p jlc-m-0">
                    <strong>Choose both</strong> if you want the best balance.
                  </p>
                </div>
              </div>
            </div>
            <div className="jlc-summary-video">
              <div className="jlc-video-wrapper">
                <iframe
                  src="https://www.youtube.com/embed/Y5ceB_FUVqA"
            ...
            <table className="japan-comparison-table">
              ...
              <tbody>
                <tr>
                  <td>Depth</td>
                  <td>
                    <span className="japan-tag japan-tag-high">High</span>
                  </td>
                  <td>
                    <span className="japan-tag japan-tag-mod">Moderate</span>
                  </td>
                </tr>
                <tr>
                  <td>Convenience</td>
                ...
                <tr>
                  <td>Food</td>
                  <td>
                    <span className="japan-tag japan-tag-exc">Excellent</span>
                  </td>
                  <td>
                    <span className="japan-tag japan-tag-mod">Moderate</span>
                  </td>
                ...
                <tr>
                  ...
                  <td>
                    <span className="japan-tag japan-tag-mod">Low</span>
                  </td>
                </tr>
                <tr>
                  <td>Pace</td>
                ...
                <tr>
                  ...
                  <td>
                    <span className="japan-tag japan-tag-yes">Yes</span>
                  </td>
                  <td>Sometimes</td>
                </tr>
              </tbody>
        ...
        <div className="japan-inner">
          ...
          <div className="japan-trust-grid jlc-mt-40">
            <div className="japan-trust-point">
              <div className="japan-trust-icon-box">
                <Users size={22} />
              </div>
              <h4 className="jlc-mb-10">First-time visitors</h4>
              <p className="japan-section-p jlc-stat-p">
          ...
          <div className="japan-choice-grid jlc-mt-60">
            <div className="japan-choice-card land">
              <div className="jlc-card-header-flex">
                ...
                <h3 className="jlc-card-header-title-land">
                  What a Japan Land Trip Looks Like
                </h3>
              </div>
              <ul className="japan-choice-list">
                <li>
                  <Zap size={18} className="japan-expert-icon" /> 3 nights in
                  Tokyo
                </li>
                <li>
                  <Sun size={18} className="japan-expert-icon" /> 3 nights in
                  Kyoto
                </li>
                <li>
                  <Mountain size={18} className="japan-expert-icon" /> 2 nights
                  in Hakone
                </li>
                <li>
                  <Utensils size={18} className="japan-expert-icon" /> 2 nights
                  in Osaka
                </li>
              </ul>
              <p className="japan-section-p jlc-card-p">
                This structure allows you to move through the country and
                experience it properly. If you are planning your route, start
                with our first-time Japan itinerary.
              </p>
            </div>
            <div className="japan-choice-card cruise">
              <div className="jlc-card-header-flex">
                <Ship size={28} className="jlc-text-blue-light-japan-cruise" />
                <h3 className="jlc-m-0">
                  What a Japan Cruise Itinerary Looks Like
                </h3>
              </div>
              <ul className="japan-choice-list">
                <li>
                  <Anchor size={18} className="jlc-text-blue-light" /> Tokyo
                  embarkation
                </li>
                <li>
                  <Mountain size={18} className="jlc-text-blue-light" /> Shimizu
                </li>
                <li>
                  <Utensils size={18} className="jlc-text-blue-light" /> Osaka
                  or Kobe
                </li>
                <li>
                  <Map size={18} className="jlc-text-blue-light" /> Hiroshima
                </li>
                <li>
                  <Globe size={18} className="jlc-text-blue-light" /> Busan,
                  South Korea
                </li>
                <li>
                  <RotateCcw size={18} className="jlc-text-blue-light" /> Return
                  to Tokyo
                </li>
              </ul>
          ...
          <div className="japan-choice-grid jlc-mt-60">
            <div className="japan-expert-card jlc-p-40">
              <div className="jlc-cost-header-flex">
                <div className="japan-trust-icon-box jlc-m-0">
                  <DollarSign size={24} />
                </div>
              ...
              <p className="japan-section-p jlc-cost-desc">
                Land gives you complete control over your budget and
                experiences.
              </p>
            </div>
            <div className="japan-expert-card jlc-p-40">
              ...
              <p className="japan-section-p jlc-cost-amount">
                $5,000 – $15,000+{" "}
                <span className="jlc-cost-unit">/ person</span>
              </p>
              <p className="japan-section-p jlc-cost-desc">
                Cruises offer predictable, bundled pricing with luxury
                inclusions.
              </p>
            </div>
          </div>
        ...
        <div className="japan-inner">
          ...
          <div className="japan-choice-grid jlc-mt-60">
            <div className="japan-choice-card jlc-card-light-border">
              ...
              <ul className="japan-choice-list">
                <li>
                  <Moon size={18} className="japan-expert-icon" /> Late-night
                  Tokyo
                </li>
                <li>
                  <Sun size={18} className="japan-expert-icon" /> Kyoto early
                  mornings
                </li>
                <li>
                  <Utensils size={18} className="japan-expert-icon" /> Street
                  food in Osaka
                </li>
                <li>
                  <Coffee size={18} className="japan-expert-icon" /> Ryokan
                  stays and cultural immersion
                </li>
              </ul>
            </div>
            <div className="japan-choice-card jlc-card-light-border">
              <div className="jlc-card-header-flex">
                ...
                <h3 className="jlc-text-navy-dark-m0">
                  On a cruise, you gain:
                </h3>
              </div>
              <ul className="japan-choice-list">
                <li>
                  <Zap size={18} className="japan-expert-icon" /> Ease
                </li>
                <li>
                  <Layers size={18} className="japan-expert-icon" /> Structure
                </li>
                <li>
                  <CheckCircle size={18} className="japan-expert-icon" />{" "}
                  Simplicity
                </li>
              </ul>
          ...
          <div className="jlc-cruises-miss-grid">
            ...
            <div className="jlc-miss-highlight">
              <p className="japan-section-p jlc-miss-quote">
                "Many of the most meaningful moments happen in these times and
                places."
              </p>
            </div>
          </div>
          ...
          <div className="jlc-who-grid">
            ...
            <div className="jlc-who-card jlc-who-land">
              ...
              <ul className="jlc-who-list">
                ...
                <li>
                  <Heart size={18} />
                  <span>Couples and honeymooners</span>
                </li>
                <li>
                  <Utensils size={18} />
                ...
                <li>
                  <Search size={18} />
                  <span>Travelers seeking depth</span>
                </li>
                <li>
                  <Compass size={18} />
                  <span>Those wanting flexibility</span>
                </li>
              </ul>
            </div>
            {/* Cruise */}
            <div className="jlc-who-card jlc-who-cruise">
              <div className="jlc-who-header">
                <div className="jlc-who-icon jlc-who-icon-cruise">
                  <Ship size={24} />
                </div>
                <h3 className="jlc-who-title jlc-text-white">
              ...
              <ul className="jlc-who-list jlc-who-list-cruise">
                <li>
                  <Ship size={18} />
                  <span>Travelers who love cruising</span>
                </li>
                <li>
                  <Zap size={18} />
                  <span>Those wanting minimal logistics</span>
                </li>
                <li>
                  <Globe size={18} />
                  <span>Travelers combining multiple countries</span>
                </li>
                <li>
                  <Clock size={18} />
                  <span>Those who prefer a slower pace</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="jlc-who-grid jlc-mt-48">
            <div className="jlc-not-card">
              <div className="jlc-not-header">
                ...
                <h3 className="jlc-not-title">
                  Who Should Not Choose a Japan Cruise
                </h3>
              </div>
              <ul className="jlc-not-list">
                <li>
                  <BookOpen size={18} className="jlc-not-list-icon-inline" />
                  <span>Travelers seeking deep immersion</span>
                </li>
                <li>
                  <Clock size={18} className="jlc-not-list-icon-inline" />
                  <span>First-time visitors with limited time</span>
                </li>
                <li>
                  <Utensils size={18} className="jlc-not-list-icon-inline" />
                  <span>Food-focused travelers</span>
                </li>
              </ul>
            </div>
            <div className="jlc-not-card">
              ...
              <ul className="jlc-not-list">
                <li>
                  <Layout size={18} className="jlc-not-list-icon-inline" />
                  <span>Travelers who want minimal planning</span>
                </li>
                <li>
                  <List size={18} className="jlc-not-list-icon-inline" />
                  <span>Those who prefer structured travel</span>
                </li>
                <li>
                  <Ship size={18} className="jlc-not-list-icon-inline" />
                  <span>Travelers strongly committed to cruising</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="japan-inner">
          <div className="jlc-cost-wrapper">
            <div className="jlc-cost-left">
              ...
              <h2 className="japan-h2 jlc-mt-16">
                Is Japan Land Travel or Cruise More Expensive?
              </h2>
              <p className="japan-section-p">
                Land typically delivers better value for Japan-focused trips,
                while cruises work well for multi-country itineraries.
              </p>
              <div className="jlc-cost-footer">
                <p className="japan-section-p jlc-cost-footer-p">
                  Timing also matters. See our best time to visit Japan guide
                  for more.
                </p>
              </div>
            </div>
            <div className="jlc-cost-right">
              <div className="jlc-cost-point">
                ...
                <div className="jlc-cost-point-text">
                  ...
                  <p className="jlc-cost-point-title">
            ...
            <div className="jlc-ft-grid">
              <div className="jlc-ft-content">
                ...
                <p className="japan-section-p jlc-ft-p">
                  For most first-time visitors, land travel is the better
                  option. It allows you to move deep into the heart of Japan's
                  most iconic cities at your own pace.
                </p>
          ...
          <div className="jlc-worry-wrapper">
            <div className="jlc-worry-visual">
              ...
              <div className="jlc-worry-stat">
                ...
                <p className="jlc-worry-stat-label">
                  Smoother than almost anywhere in the world — when structured
                  correctly.
                </p>
              </div>
            </div>
            <div className="jlc-worry-content">
              ...
              <p className="japan-section-p">
                Japan can feel complex to plan, but when structured correctly,
                it runs smoother than almost anywhere in the world.
              </p>
              <div className="jlc-worry-highlight">
                <p className="japan-section-p jlc-worry-highlight-p">
                  The key is not avoiding land travel. It is planning it
                  properly.
                </p>
              </div>
      ...
      <section className="japan-section japan-bg-white">
        <div className="japan-inner">
          ...
          <div className="japan-inner-narrow jlc-hybrid-intro">
            <p className="japan-section-p jlc-fs-18">
        ...
        <div className="japan-inner">
          ...
          <div className="japan-choice-grid jlc-mt-60">
            <div className="japan-trust-point-first jlc-text-left">
              ...
              <p className="japan-section-p jlc-fw-600">
        ...
        <div className="japan-inner">
          <div className="jlc-clients-wrapper">
            <div className="jlc-clients-left">
              ...
              <p className="japan-section-p">
                Every year, I see the same patterns repeat. The difference is
                not the destination. It is how you experience it.
              </p>
              <div className="jlc-clients-verdict">
                <p className="japan-section-p jlc-clients-verdict-p">
                  "The difference is not the destination. It is how you
                  experience it."
                </p>
              </div>
            </div>
            <div className="jlc-clients-right">
              ...
              <div className="jlc-obs-lightbulb">
                ...
                <p className="japan-section-p jlc-m-0">
                  Understanding the trade-offs before you book changes
                  everything.
                </p>
              </div>
            </div>
      ...
      <section className="japan-section japan-bg-navy jlc-text-center">
        <div className="japan-inner-narrow">
          <h2 className="japan-h2 jlc-text-white">
            My Personal Take <br /> After Living in Japan
          </h2>
          ...
          <p className="japan-section-p jlc-take-p2">
            It allows you to move intentionally and experience the country in
            layers.
          </p>
        </div>
      </section>
      ...
      <section className="japan-section japan-bg-white">
        <div className="japan-inner">
          <div className="japan-inner-narrow jlc-remember-box">
            <h2 className="japan-h2 jlc-mb-40">
              If You Only Remember One Thing
            </h2>
          ...
          <div className="jlc-plan-wrapper">
            <div className="jlc-plan-left">
              <div className="jlc-plan-award-box">
                ...
                <p className="japan-section-p jlc-plan-award-subtitle">
            ...
            <div className="jlc-plan-right">
              ...
              <ul className="jlc-plan-list">
                <li>
                  <div className="jlc-plan-list-icon">
                    <Layout size={18} />
                  </div>
              ...
              <button className="japan-btn-primary jlc-mt-40">
                Plan My Japan Trip
              </button>
            </div>
          </div>
      ...
      <section className="japan-section japan-bg-white">
        <div className="japan-inner">
          <div className="jlc-next-header">
            ...
            <p className="japan-section-p jlc-next-subtitle">
              Continue your journey with our most popular Japan planning
              resources.
            </p>
          </div>
      ...
      <section className="BTJapan_faq_section japan-bg-soft">
        <div className="BTJapan_faq_inner">
          ...
          <BTJapanFAQ
            items={[
              {
                q: "Is Japan better by land or cruise?",
                a: "Land travel is better for most travelers due to deeper cultural immersion.",
              },
              {
                q: "Is a Japan cruise worth it?",
                a: "Yes, especially for travelers who value convenience and multi-country travel.",
              },
              {
                q: "Should I travel Japan by train or cruise?",
                a: "Train-based travel is usually better for experiencing Japan.",
              },
              {
                q: "Is a cruise good for a first trip?",
                a: "It can be, but land travel is typically more immersive.",
              },
              {
                q: "Can I combine land and cruise?",
                a: "Yes, and it is often the best approach.",
              },
              {
                q: "Do cruises visit major cities?",
                a: "They visit nearby ports but do not provide the same depth.",
              },
              {
                q: "Is land travel difficult?",
                a: "It requires planning but is very rewarding.",
              },
              {
                q: "What is the best way to see Japan?",
                a: "A land itinerary covering Tokyo, Kyoto, and Osaka.",
              },
              {
                q: "Are cruises cheaper?",
                a: "Not always. It depends on travel style and timing.",
              },
              ...
              { q: "How many days do I need?", a: "10 to 14 days is ideal." },
              {
                ...
                a: "Choosing convenience over experience without understanding the trade-offs.",
              },
            ]}
          />
        </div>
